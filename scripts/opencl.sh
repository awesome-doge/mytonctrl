...
apt install -y build-essential git make cmake clang libgflags-dev zlib1g-dev libreadline-dev libmicrohttpd-dev pkg-config libgsl-dev python3 python3-dev python3-pip screen
